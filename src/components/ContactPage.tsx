    ...
    <div className="min-h-screen bg-black">
      ...
      <section className="bg-black py-16 lg:py-48">
        <div className="max-w-[1600px] mx-auto px-6 lg:px-20" style={{ backgroundImage: 'radial-gradient(circle at 1px 1px, rgb(255 255 255 / 0.05) 1px, transparent 0)', backgroundSize: '40px 40px' }}>
          ...
          >
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3261.2551902734454!2d136.91335777522724!3d35.17519165760701!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6003713cab646097%3A0x2ca16ba65c1a88b7!2z5ZCI5ZCM5Lya56S-SEFDUw!5e0!3m2!1sja!2sjp!4v1787758208431!5m2!1sja!2sjp" width="800" height="600" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="strict-origin-when-cross-origin""
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
